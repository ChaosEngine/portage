...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/Attic/mplayer-1.0_rc4_p20120128.ebuild,v 1.4 2012/02/19 13:53:59 aballier dead $
...
if [[ ${PV} == *9999* ]]; then
	...
	RELEASE_URI="http://overlay.linuxsystems.it/${P}.tar.xz"
fi
SRC_URI="${RELEASE_URI}
	!truetype? ( ${FONT_URI} )"
